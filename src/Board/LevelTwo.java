...
/***
 * Class defining the second level built by players on the board
 * Created by:
 * @author May McGrath
 */
public class LevelTwo extends Square{
    ...
    public LevelTwo (int xpos, int ypos) {
        ...
        try {
            InputStream is = getClass().getClassLoader().getResourceAsStream("level2.png");
            if (is == null) {
